...
a_d.plot.bar()
plt.xlabel('Día',fontdict={'fontsize': 12,'fontweight': 10})
plt.ylabel('Cant. de mensajes',fontdict={'fontsize': 12,'fontweight': 10})
plt.title('Días más activos',fontdict={'fontsize': 16,'fontweight': 8})
plt.show()
...
plt.title('Imágenes enviadas por persona',fontdict={'fontsize': 16,'fontweight': 8})
plt.xticks(x_pos, bars)
plt.show()
...
a_m.plot.bar()
plt.ylabel('Cant. de mensajes',fontdict={'fontsize': 12,'fontweight': 10})
plt.title('Meses más activos',fontdict={'fontsize': 16,
        'fontweight': 8})
plt.show()
...
a_m.plot.bar()
plt.ylabel('Cant. de mensajes',fontdict={'fontsize': 12,'fontweight': 10})
plt.title('Mensajes por año',fontdict={'fontsize': 16,'fontweight': 8})
plt.show()
